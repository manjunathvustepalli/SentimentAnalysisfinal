...
function InfluencerAnalysis() {
  ...
  const fetchData = async () => {
    if (source === "Twitter") {
      ...
      Axios(config)
        .then((res) => {
          let finaldata = res.data.aggregations[
            "date-based-range"
          ].buckets[0].Users.buckets.map((doc) => {
            if (
              doc.Sentiment.buckets[0] &&
              sentiments[doc.Sentiment.buckets[0].key] == true
            ) {
              return {
                influencer: (
                  <div
          ...
          var filtered = finaldata.filter(function (x) {
            return x !== undefined;
          });
                ...
                <Card className={classes.main}>
                  <Grid container spacing={2}>
                    <Grid item xs={12} md={7}>
                      <CardContent>Top Influencers</CardContent>
                    </Grid>
                    <Grid xs={12} md={5}>
                ...
                <Card className={classes.main}>
                    ...
                    <Grid container spacing={2} style={{ marginTop: "20px" }}>
                      ...
                      <Grid item xs={7} align={"right"}>
                        <Tabs
                          ...
                          textColor="primary"
                          TabIndicatorProps={{
                            style: { backgroundColor: "rgb(67, 176, 42)" },
                          }}
                          variant="scrollable"
                          scrollButtons="auto"
                        ...
                        >
                          <Tab
                            ...
                            style={{
                              color: value === 0 && "white",
                              backgroundColor:
                                value === 0 && "rgb(67, 176, 42)",
                              border:
                                value !== 0 && "2px solid rgb(67, 176, 42)",
                            }}
                            {...a11yProps(0)}
                          />
                          <Tab
                            ...
                            style={{
                              color: value === 1 && "white",
                              backgroundColor:
                                value === 1 && "rgb(67, 176, 42)",
                              border:
                                value !== 1 && "2px solid rgb(67, 176, 42)",
                            }}
                            {...a11yProps(1)}
                          />
                        </Tabs>
                  ...
                  <Grid item xs={11}>
                    <TabPanel value={value} index={0}>
                      <TreeMap
                        title={`${source} Influence comparison Treemap based on Sentiment`}
                        data={sentimentData}
                      />
                      <div
                        style={{
                    ...
                    <TabPanel value={value} index={1}>
                      <div id="treemap-wrapper" style={{ width: "100%" }}>
                        <TreeMap
                          title={`${source} Influence comparison Treemap based on Mood`}
                          data={moodData}
                        />
                      </div>
                      <div
