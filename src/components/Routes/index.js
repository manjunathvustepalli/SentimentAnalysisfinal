              ...
              <BrowserRouter>
                <Switch>
                  ...
                  <SideNav>
                    ...
                    />
                    <Route
                      path="/word-cloud/sentiment"
                      exact
                      component={wordCloudSentiment}
                    />
                    <Route
                      path="/word-cloud/mood"
                      exact
                      component={WordCloudMood}
                    />
                    <Route
                    ...
                    />
                    <Route
                      path="/trend-analysis/stacked-bar-chart"
                      exact
                      component={() => <TrendAnalysis stacking />}
                    />
                    <Route
                      path="/trend-analysis/area-chart"
                      exact
                      component={TrendAnalysisAreaChart}
                    />
                    <Route
                      path="/trend-analysis/line-chart"
                      exact
                      component={TrendAnalysisLineChart}
                    />
                    <Route
                      path="/trend-analysis/pie-chart"
                      exact
                      component={TrendAnalysisPieChart}
                    />
                    <Route
                      path="/trend-analysis/semi-pie-chart"
                      exact
                      component={TrendAnalysisSemiDonut}
                    />
                    <Route path="/demography" exact component={Demography} />
                    <Route
                      path="/trending-subject/sentiment"
                      exact
                      component={TrendingSubjectsSentiment}
                    />
                    <Route
                      path="/trending-subject/mood"
                      exact
                      component={TrendingSubjectsMood}
                    />
                    <Route
                      path="/live-analysis"
                      exact
